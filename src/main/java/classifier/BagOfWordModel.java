...
public class BagOfWordModel {
    ...
    public static NGramVocabularyBuilder nGramVocabularyBuilder = new NGramVocabularyBuilder(new NGramTokenizer(2, true));
    ...
    public static WekaToWordVector wekaToWordVector = new WekaToWordVector();
}
